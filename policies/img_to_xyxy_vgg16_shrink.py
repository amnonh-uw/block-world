...
class vgg16(Network):
    ...
    def setup(self):
        (self.feed('img1')
         .conv(3, 3, 8, 1, 1, name='conv1_1', c_i=3)
         .conv(3, 3, 8, 1, 1, name='conv1_2', c_i=8)
         .max_pool(2, 2, 2, 2, name='pool1')
         .conv(3, 3, 16, 1, 1, name='conv2_1', c_i=8)
         .conv(3, 3, 16, 1, 1, name='conv2_2', c_i=16)
         .max_pool(2, 2, 2, 2, name='pool2')
         .conv(3, 3, 32, 1, 1, name='conv3_1', c_i=16)
         .conv(3, 3, 32, 1, 1, name='conv3_2', c_i=32)
         .conv(3, 3, 32, 1, 1, name='conv3_3', c_i=32)
         .max_pool(2, 2, 2, 2, name='pool3')
         .conv(3, 3, 64, 1, 1, name='conv4_1', c_i=32)
         .conv(3, 3, 64, 1, 1, name='conv4_2', c_i=64)
         .conv(3, 3, 64, 1, 1, name='conv4_3', c_i=64)
         .max_pool(2, 2, 2, 2, name='pool4')
         .conv(3, 3, 64, 1, 1, name='conv5_1', c_i=64)
         .conv(3, 3, 64, 1, 1, name='conv5_2', c_i=64)
         .conv(3, 3, 64, 1, 1, name='conv5_3', c_i=64)
